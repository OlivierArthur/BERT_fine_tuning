...
W pierwszej iteracji porównania training setów w TrainingArguments nie było weight decay, były 3 epoki i learning rate 3e-5. Nie było stratified samplingu dla zbiorów treningowych i testowych. Na wykresach można było zaobserwować overtraining w zbiorach treningowych enron i lingspam. W przypadku SpamAssassin trenowanie przez 3 epoki z większym learning rate było efektywne, co można zobaczyć na wykresach w folderach.
